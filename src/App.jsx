    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1 ">
        <div>
          ...
          <h1 className="text-5xl/tight font-bold mb-6">Hi,I'm Kuro Hito</h1>
      ...
      <div className="about mt-32 py-10">
        <div className="w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg">
          ...
          <p className="text-base/loose mb-10">
            Fullstack Developer by passion and problem-solver by nature. I love
            building things that make an impact — whether it's web applications,
            digital products, or creative ideas. Currently exploring everything
            that sparks curiosity: collaborating on startups, crafting clean
            code, and helping others grow through mentoring and content
            creation.
          </p>
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50">
            {" "}
            Here are some of the tools I frequently use in my development
            workflow
          </p>
